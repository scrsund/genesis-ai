      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {problems.map((problem, index) => (
            <div
              key={index}
              className="border border-white/10 bg-black/50 p-6 transition-all hover:border-primary/40 hover:translate-y-[-5px]"
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium tracking-wide text-white/90 uppercase mb-2">
                    {problem.title}
                  </h3>
        ...
        <div className="mt-16 text-center max-w-2xl mx-auto">
          <p className="text-xl text-white/90 italic">
            AI is no longer optional. The businesses that automate the beginning
